...
compselector.value = "Galileo Championship";
...
var eventName = competitionList[competitionList.length-2][0];
var eventURL = competitionList[competitionList.length-2][1];
